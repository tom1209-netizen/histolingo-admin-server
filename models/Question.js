...
const MultipleChoiceQuestion = BaseQuestion.discriminator('1', multipleChoiceSchema);
const MatchingQuestion = BaseQuestion.discriminator('2', matchingSchema);
const FillInTheBlankQuestion = BaseQuestion.discriminator('3', fillInTheBlankSchema);

export { BaseQuestion, TrueFalseQuestion, MultipleChoiceQuestion, MatchingQuestion, FillInTheBlankQuestion };